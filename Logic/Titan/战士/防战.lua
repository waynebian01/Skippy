...
local BattleShoutByPlayer = Skippy.GetPlayerAuraByName("战斗怒吼") -- 战斗怒吼,自己施放的[战斗怒吼]
local BattleShout = Skippy.GetPlayerAuraByName("战斗怒吼", false) -- 战斗怒吼,任意单位施放的[战斗怒吼]
local CommandShoutByPlayer = Skippy.GetPlayerAuraByName("命令怒吼") -- 命令怒吼,自己施放的[命令怒吼]
local CommandShout = Skippy.GetPlayerAuraByName("命令怒吼", false) -- 命令怒吼,任意单位施放的[命令怒吼]
local Might = Skippy.GetPlayerAuraByName("力量祝福", false) -- 力量祝福
local GreaterMight = Skippy.GetPlayerAuraByName("强效力量祝福", false) -- 强效力量祝福
local SwordBoard = Skippy.GetPlayerAuraByName("剑盾猛攻") -- 剑盾猛攻,盾牌猛击技能结束冷却，并使其消耗的怒气值减少100%
